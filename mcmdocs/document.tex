...
\begin{table}[h]
    ...
    \begin{tabular}{>{\centering\arraybackslash}p{6em}>{\centering\arraybackslash}p{30em}}
        ...
        \midrule % 绘制第2条线
        $M
        (i,t)$           & Position of the $i$-th drone
        \uppercase\expandafter{\romannumeral1} at time $t$                               \\
        $R
        (j,t)$           & Position of the $j$-th drone
        ...
        $\beta
        (x,y,z)$         & Weight of slope                                               \\
        $\gamma$         & Factor for slope                                              \\
        $\omega
        (x,y,z)$         & Decreasing rate of signal at point $(x,y,z)$                  \\
        $\alpha$         & Elevational factor                                            \\
        $Chg
        (q,x,y,z)$       & $q$th charging station's position                             \\
        $V_{max}$        & Maximum flying velocity of a drone                            \\
        $N_{\text{SSA}}$ & Total number of drone
        \uppercase\expandafter{\romannumeral1}                                           \\
        $N/repeater$     & Total number of drone
        \uppercase\expandafter{\romannumeral2}                                           \\
        $PF$             & Power consumption for a flying drone                          \\
        $PH$             & Power consumption for a hovering drone                        \\
        $t_{flying}
        (T,l)$           & Total time interval for flying at time $T$ for $l$-th drone   \\
        $t_{hovering}
        (T,l)$           & Total time interval for hovering at time $T$ for $l$-th drone \\
        $T$              & Total time                                                    \\
        $Br$             & Total power for a drone                                       \\
        $Ini$            & The position of command center                                \\
        \bottomrule
    \end{tabular}
\end{table}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
